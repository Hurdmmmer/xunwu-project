...
public class HouseVo implements Serializable {
    ...
    private List<HousePictureVo> pictures;
    ...
    public void setHouseDetail(HouseDetailVo houseDetail) {
    ...
    public List<HousePictureVo> getPictures() {
        return pictures;
    }

    public void setPictures(List<HousePictureVo> pictures) {
